			...
			<div className="flex flex-col md:flex-row bg-white rounded-lg overflow-hidden ">
				<div className="w-full md:w-1/2 p-8 flex flex-col justify-center">
					...
					<p className="text-gray-600 mb-8">
						Ted way you're better, awesome and new will always work a huge
						fucking shit there.
					</p>
						...
						<div className="absolute top-7 -left-8 bg-white text-white px-6 py-3 rounded-lg shadow-md">
							<div className="flex gap-2">
								...
								<div>
									...
									<div className="text-xs text-blue-950 max-w-[110px] text-left leading-tight mt-1">
										Make an consult appointment
									</div>
								</div>
							</div>
						</div>
