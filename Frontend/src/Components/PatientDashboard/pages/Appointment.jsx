...
const Appointment = () => {
  ...
  const navigate = useNavigate();
	...
	return (
      ...
      <h4 onClick={() => navigate("/") } className="cursor-pointer border-2 w-[fit-content] py-1 bg-blue-600 hover:bg-blue-700 text-white font-medium px-4 rounded-md transition-colors">Home</h4>
